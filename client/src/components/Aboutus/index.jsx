  ...
  return (
    <div className='about-container'>
        ...
        <div className='execution-container'>
            <h2>EXECUTION</h2>
            <p>A  drive to see things through to completion as quickly, efficiently, and effectively as possible. We believe in the time to see projects through from start to finish in order to get exceptional results.</p>
        </div>
