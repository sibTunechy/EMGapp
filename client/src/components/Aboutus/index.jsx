  ...
  return (
    <div className='about-container'>
        ...
        <div className='excellence-container'>
            <h2>EXCELLENCE</h2>
            <p>Consistently delivering exceptional . Every employees's heart beat with the phrase "Excellence". To provide measureable value to our stakeholders, we go above and beyond the ordinary.</p>   
        </div>
    </div>
  )
}
